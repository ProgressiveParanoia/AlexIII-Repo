<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST")
  {
    ...
    $sql = "UPDATE history_description SET description=?, header=? WHERE id = 1";
    ...
    $file = $_FILES['history_image'];
      ...
      if(in_array($fileActualExtensison, $allowedFileExtensions))
      {
        if($fileError === 0)
        {
          ...
          $fileName = "history_image" . ".jpg";//"." . $fileActualExtensison;
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            <!-- History of Alex III-->
          	<h3><i class="fa fa-angle-right"></i> History of Alex III</h3>
            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i>Current History Description</h4>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <div class="col-sm-12">
            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i>Current History Image</h4>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <div class="col-sm-12">
                                <span class="help-block">
                                  ...
                                  <!--<?php //echo $description; ?>-->
                                    ...
                                    <img src="uploads/history_image.jpg">
                                  </center></span>
                                </span>
                              </div>
                          </div>
