        ...
        if(array_key_exists("add_gallery_image", $_POST))
        {
            ...
            if(in_array($fileActualExtensison, $allowedFileExtensions))
            {
                if($fileError === 0)
                {
                  ...
                  $fileDestination = 'uploads/menu/' . $fileName;
                        ...
                        <?php 
                            if(empty($gallery_images)){
                                ...
                                for($i = 2; $i < count($gallery_images) + 2; $i++)
                                {
                                    ...
                                    if(strpos($current_slider_name, ".jpg"))
                                    {
                                      echo "<li><image width=300 height=240 src='uploads/menu/".$current_slider_name."'></li>";
                                    }else
                                     ...
                                     // </video>
                                      ...
                                      echo "<li>
                                              <video width=300 height=240 controls>
                                                <source src='uploads/menu/".$current_slider_name."' type='video/mp4'>
                                              </video>
                                            </li>";
                                    }
